...
public class adminController {
	...
	private void delete(ActionEvent event) {
		...
		if(section.getText().equals("Book")) {
			try {	
				//Creating PreparedStatement object
				PreparedStatement preparedStatement = connection.prepareStatement("delete from book where isbn="+col_1.getText()+" and title="+col_2.getText()+" and author="+col_3.getText());
				preparedStatement.executeUpdate();
				//information message
		...
		//delete games data
			...
			try {	
				//Creating PreparedStatement object
				PreparedStatement preparedStatement = connection.prepareStatement("delete from games where id="+col_1.getText()+" and title="+col_2.getText());
				preparedStatement.executeUpdate();
				//information message
				alertInfo.setContentText("New data is deleted successfully.");
				alertInfo.show();
